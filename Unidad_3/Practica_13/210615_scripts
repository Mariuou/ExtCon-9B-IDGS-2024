...
-- Tabla servicios al cliente
    ...
    CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_poblar_servicios_clientes`(v_password varchar(10))
      ...
      INSERT INTO tbc_servicios_clientes VALUES
        (default, 1, "Reclamo", "El aire acondicionado en la zona de cardio no funciona.", "Cliente muy molesto, solicitó una solución inmediata.", default, default, default),
        (default, 3, default, "Sería bueno tener más clases de yoga por la mañana.", "Comentario positivo sobre las clases actuales de yoga.", default, default, default),
        (default, 4, default, "El servicio del entrenador personal ha sido excelente.", "Cliente muy contento con los resultados obtenidos.", default, default, default),
        (default, 5, default, "Las máquinas de pesas no se limpian regularmente.", "Cliente sugirió más toallas desinfectantes cerca de las máquinas de pesas.", default, default, default);
...
-- Tabla servicios sucursales
   ...
   INSERT INTO tbb_instalaciones VALUES
            (default, 'Cardio Zone', "Área con equipos de cardio para mejorar la resistencia cardiovascular", "Área de Cardio", '2020-08-10 08:00:00', default, default, default, 1, "Lunes a Viernes de 8:00am a 8:00pm", null, null),
            (default, 'Strength Area', "Área con pesas libres para el entrenamiento de fuerza", "Área de Pesas Libres", '2020-08-10 08:00:00', default, default, default, 1, "Lunes a Viernes de 8:00am a 8:00pm", null, null),
            ...
            (default, 'HIIT Zone', "Área para entrenamientos de alta intensidad", "Área de Entrenamiento HIIT", '2020-08-10 08:00:00', default, default, default, 1, "Lunes a Viernes de 8:00am a 8:00pm", null, null);
...
-- Tabla equipamiento
    ...
    CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_poblar_equipamientos`(v_password varchar(10))
        ...
        (default, 'Cardio HIT', "Bicicleta estática para cardio", "Schwinn 170 Upright Bike", "MAD-123", null, '2020-08-10 08:00:00', default, default, default),
        (default, 'Pesas libres', "Pesas ajustables para entrenamiento de fuerza", "Bowflex SelectTech 552 Dumbbells", "MAD-123", null, '2020-08-10 08:00:00', default, default, default),
        (default, 'Máquinas de Fuerza', "Máquina para ejercitar piernas", "Body-Solid Leg Press & Hack Squat GLPH1100", "MAD-123", null, '2020-08-10 08:00:00', default, default, default),
        (default, 'Peso Corporal y Funcional', "Barras para dips y entrenamiento funcional", "Lebert Equalizer Bars", "MAD-123", null, '2020-08-10 08:00:00', default, default, default),
        (default, 'Estiramiento y Flexibilidad', "Dispositivo para estiramiento de pantorrillas", "ProStretch Plus Calf Stretcher", "MAD-123", null, '2020-08-10 08:00:00', default, default, default);
...
INSERT INTO tbb_instalaciones VALUES
        (default, 'Cardio Zone', "Área con máquinas de cardio para mejorar la capacidad cardiovascular", "Zona de Cardio", '2020-08-10 08:00:00', default, default, default, 1, "Lunes a Viernes de 8:00am a 8:00pm", null, null),
        (default, 'Strength Area', "Espacio equipado con pesas libres para entrenamientos de fuerza", "Zona de Pesas Libres", '2020-08-10 08:00:00', default, default, default, 1, "Lunes a Viernes de 8:00am a 8:00pm", null, null),
        (default, 'Flexibility Corner', "Área designada para ejercicios de estiramiento y flexibilidad", "Zona de Estiramiento", '2020-08-10 08:00:00', default, default, default, 1, "Lunes a Viernes de 8:00am a 8:00pm", null, null),
        (default, 'Group Class Studio', "Espacio destinado a diversas clases grupales", "Zona de Clases Grupales", '2020-08-10 08:00:00', default, default, default, 1, "Lunes a Viernes de 8:00am a 8:00pm", null, null),
        (default, 'HIIT Zone', "Área para entrenamientos de alta intensidad", "Zona de Entrenamiento HIIT", '2020-08-10 08:00:00', default, default, default, 1, "Lunes a Viernes de 8:00am a 8:00pm", null, null);
...
INSERT INTO tbc_ejercicios VALUES 
    (DEFAULT, "Peso Muerto", "Ejercicio para levantar una carga desde el suelo, implicando la extensión de la cadera y estabilidad del torso.", null, "Cardio", default, 'Principiante', default, null, 'calentar', 'Evitar malas posturas'),
    (DEFAULT, "Planchas", "Ejercicio isométrico para fortalecer los músculos del torso, manteniendo el cuerpo en posición recta y estable.", null, "Fuerza", default, 'Intermedio', default, null, 'calentar', 'Evitar malas posturas'),
    (DEFAULT, "Prensas", "Ejercicio enfocado en la extensión de la cadera y estabilidad del torso, similar a levantar una carga desde el suelo.", null, "Fuerza", default, 'Intermedio', default, null, 'calentar', 'Evitar malas posturas'),
    (DEFAULT, "Pesas", "Ejercicio de levantamiento que requiere la extensión de la cadera y estabilidad del torso, usando pesas como resistencia.", null, "Fuerza", default, 'Avanzado', default, null, 'calentar', 'Evitar malas posturas'),
    (DEFAULT, "Bíceps", "Ejercicio para levantar una carga desde el suelo, trabajando principalmente los músculos de los brazos y la estabilidad del torso.", null, "Cardio", default, 'Avanzado', default, null, 'calentar', 'Evitar malas posturas');
