...
-- quitar 
`ServiciosCliente_ID` int unsigned NOT NULL
-- agregar los campos de fecha actualización y fecha de registro
...
SELECT i.Nombre AS NombreInstalacion,
       i.Sucursal_ID AS IDSucursal,
       i.Descripcion AS DescripcionInstalacion
FROM tbb_instalaciones i
JOIN tbc_sucursales s ON i.Sucursal_ID = s.ID;
