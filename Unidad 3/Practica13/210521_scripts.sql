...
Elaborado por: Ing. Ameli Pérez Garrido
Grado y Grupo: 9B
...
-- Tabla servicios al cliente
    ...
    CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_poblar_servicios_clientes`(v_password varchar(10))
       ...
       INSERT INTO tbc_servicios_clientes VALUES
        (default, 1, "Reclamo", "El aire acondicionado en el área de cardio no está funcionando.", "Cliente muy enojado, pidió una solución inmediata.", default, default, default),
        (default, 3, default, "Sería beneficioso tener más clases de yoga por la mañana.", "Comentario positivo sobre las clases actuales.", default, default, default),
        (default, 4, default, "Excelente servicio del entrenador personal.", "Cliente muy satisfecho con los resultados obtenidos.", default, default, default),
        (default, 5, default, "Las máquinas de pesas libres no se limpian con regularidad.", "Cliente sugirió más toallas desinfectantes cerca de las máquinas.", default, default, default);
...
-- Tabla equipamiento
    ...
    CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_poblar_equipamientos`(v_password varchar(10))
        ...
        (default, 'Cardio', "Bicicleta estacionaria", "Schwinn 170 Upright Bike", "MAD-123", null, '2020-08-10 08:00:00', default, default, default),
        (default, 'Pesas libres', "Pesas de mano", "Bowflex SelectTech 552 Dumbbells", "MAD-123", null, '2020-08-10 08:00:00', default, default, default),
        (default, 'Máquinas de Fuerza', "Máquina de piernas", "Body-Solid Leg Press & Hack Squat GLPH1100", "MAD-123", null, '2020-08-10 08:00:00', default, default, default),
        (default, 'Peso Corporal y Entrenamiento Funcional', "Barras dip", "Lebert Equalizer Bars", "MAD-123", null, '2020-08-10 08:00:00', default, default, default),
        (default, 'Estiramiento y Flexibilidad', "Barras para estiramiento", "ProStretch Plus Calf Stretcher", "MAD-123", null, '2020-08-10 08:00:00', default, default, default);
...
-- Tabla instalaciones
    ...
    CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_poblar_instalaciones`(v_password varchar(10))
        ...
        INSERT INTO tbb_instalaciones VALUES
        (default, 'Cardio Zone', "Área con equipos de cardio para mejorar la capacidad cardiovascular", "Zona de Cardio", '2020-08-10 08:00:00', default, default, default, 1, "Lunes a Viernes de 8:00am a 8:00pm", null, null),
        (default, 'Strength Area', "Espacio con pesas libres para entrenamientos de fuerza", "Zona de Pesas Libres", '2020-08-10 08:00:00', default, default, default, 1, "Lunes a Viernes de 8:00am a 8:00pm", null, null),
        (default, 'Flexibility Corner', "Área dedicada a ejercicios de estiramiento y flexibilidad", "Zona de Estiramiento", '2020-08-10 08:00:00', default, default, default, 1, "Lunes a Viernes de 8:00am a 8:00pm", null, null),
        (default, 'Group Class Studio', "Espacio para diversas clases grupales", "Zona de Clases Grupales", '2020-08-10 08:00:00', default, default, default, 1, "Lunes a Viernes de 8:00am a 8:00pm", null, null),
        (default, 'HIIT Zone', "Área destinada a entrenamientos de alta intensidad", "Zona de Entrenamiento HIIT", '2020-08-10 08:00:00', default, default, default, 1, "Lunes a Viernes de 8:00am a 8:00pm", null, null);
...
-- Tabla ejercicios
    ...
    (DEFAULT, "Peso Muerto", "Ejercicio que consiste en levantar una carga desde el suelo, involucrando la extensión de la cadera y estabilidad del torso.", null, "Aeróbico", default, 'Básico', default, null, 'calentar', 'Evitar malas posturas'),
    (DEFAULT, "Planchas", "Ejercicio isométrico que trabaja principalmente los músculos del torso, manteniendo el cuerpo recto y estable.", null, "Fuerza", default, 'Intermedio', default, null, 'calentar', 'Evitar malas posturas'),
    (DEFAULT, "Prensas", "Ejercicio que se centra en la extensión de la cadera y estabilidad del torso, similar a levantar una carga desde el suelo.", null, "Fuerza", default, 'Intermedio', default, null, 'calentar', 'Evitar malas posturas'),
    (DEFAULT, "Pesas", "Ejercicio de levantamiento que requiere la extensión de la cadera y la estabilidad del torso, implicando el uso de pesas.", null, "Fuerza", default, 'Avanzado', default, null, 'calentar', 'Evitar malas posturas'),
    (DEFAULT, "Bíceps", "Ejercicio que implica levantar una carga desde el suelo, trabajando principalmente los músculos de los brazos y la estabilidad del torso.", null, "Aeróbico", default, 'Avanzado', default, null, 'calentar', 'Evitar malas posturas');
