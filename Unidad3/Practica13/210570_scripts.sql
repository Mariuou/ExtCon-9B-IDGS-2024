...
Elaborado por: Ing. José Zahid Ramirez Estudillo 
Grado y Grupo: 9B
Programa Educativo: Ingenieria en Desarrollo y Gestion de Software
Fecha elaboracion: 19/07/2024*/
...
-- Tabla servicios al cliente
    ...
    (default, 1, "Reclamo", "El aire acondicionado está averiado.", "El cliente está insatisfecho y necesita una solución inmediata.", default, default, default),
    (default, 3, default, "Sería ideal tener más clases de yoga matutinas.", "Comentario positivo sobre las clases actuales.", default, default, default),
    (default, 4, default, "Magnífico servicio del entrenador personal.", "Cliente muy contento con los resultados obtenidos.", default, default, default),
    (default, 5, default, "Las máquinas de pesas libres no se limpian con frecuencia.", "El cliente sugirió disponer más toallas desinfectantes cerca de las máquinas.", default, default, default);
...
-- Tabla servicios sucursales
    ...
    (default, 'Cardio Zone', "Zona equipada con máquinas de cardio para mejorar la resistencia cardiovascular", "Zona Cardio", '2020-08-10 08:00:00', default, default, default, 1, "Lunes a Viernes de 8:00am a 8:00pm", null, null),
    (default, 'Strength Area', "Sección con pesas libres para el desarrollo de la fuerza", "Zona de Fuerza", '2020-08-10 08:00:00', default, default, default, 1, "Lunes a Viernes de 8:00am a 8:00pm", null, null),
    (default, 'Flexibility Corner', "Área destinada a ejercicios de estiramiento y flexibilidad", "Zona de Flexibilidad", '2020-08-10 08:00:00', default, default, default, 1, "Lunes a Viernes de 8:00am a 8:00pm", null, null),
    (default, 'Group Class Studio', "Sala destinada a diversas clases grupales", "Estudio de Clases Grupales", '2020-08-10 08:00:00', default, default, default, 1, "Lunes a Viernes de 8:00am a 8:00pm", null, null),
    (default, 'HIIT Zone', "Zona para entrenamientos de alta intensidad", "Zona HIIT", '2020-08-10 08:00:00', default, default, default, 1, "Lunes a Viernes de 8:00am a 8:00pm", null, null);
...
-- Tabla equipamiento
    ...
    (default, 'Cardio', "Bicicleta estática", "Schwinn 170 Bicicleta Vertical", "MAD-123", null, '2020-08-10 08:00:00', default, default, default),
    (default, 'Pesas libres', "Mancuernas", "Bowflex SelectTech 552 Mancuernas", "MAD-123", null, '2020-08-10 08:00:00', default, default, default),
    (default, 'Máquinas de Fuerza', "Máquina para piernas", "Body-Solid Prensa de Piernas & Hack Squat GLPH1100", "MAD-123", null, '2020-08-10 08:00:00', default, default, default),
    (default, 'Peso Corporal y Entrenamiento Funcional', "Barras paralelas", "Lebert Barras Equalizer", "MAD-123", null, '2020-08-10 08:00:00', default, default, default),
    (default, 'Estiramiento y Flexibilidad', "Barras de estiramiento", "ProStretch Plus Estirador de Gemelos", "MAD-123", null, '2020-08-10 08:00:00', default, default, default);


            update tbb_equipamientos set Area = 'Entrenamiento de Alta Intensidad' where id = 3;
            update tbb_equipamientos set Modelo = 'MAD-231' where id = 2;
...
-- Tabla instalaciones
    ...
    CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_poblar_instalaciones`(v_password varchar(10))
        ...
        INSERT INTO tbb_instalaciones VALUES
    (default, 'Cardio Zone', "Zona equipada con máquinas de cardio para mejorar la capacidad cardiovascular", "Área Cardio", '2020-08-10 08:00:00', default, default, default, 1, "Lunes a Viernes de 8:00am a 8:00pm", null, null),
    (default, 'Strength Area', "Área con pesas libres para entrenamientos de fuerza", "Área de Fuerza", '2020-08-10 08:00:00', default, default, default, 1, "Lunes a Viernes de 8:00am a 8:00pm", null, null),
    (default, 'Flexibility Corner', "Espacio dedicado a ejercicios de estiramiento y flexibilidad", "Área de Flexibilidad", '2020-08-10 08:00:00', default, default, default, 1, "Lunes a Viernes de 8:00am a 8:00pm", null, null),
    (default, 'Group Class Studio', "Espacio destinado a clases grupales variadas", "Estudio de Clases Grupales", '2020-08-10 08:00:00', default, default, default, 1, "Lunes a Viernes de 8:00am a 8:00pm", null, null),
    (default, 'HIIT Zone', "Zona para entrenamientos de alta intensidad", "Área de HIIT", '2020-08-10 08:00:00', default, default, default, 1, "Lunes a Viernes de 8:00am a 8:00pm", null, null);
...
-- Tabla ejercicios
    ...
    (DEFAULT, "Peso Muerto", "Levantamiento de una carga desde el suelo, implicando la extensión de cadera y la estabilización del torso.", null, "Aeróbico", default, 'Principiante', default, null, 'precalentar', 'Mantener buena postura'),
    (DEFAULT, "Planchas", "Ejercicio isométrico que fortalece principalmente los músculos del core, manteniendo el cuerpo recto y estable.", null, "Fuerza", default, 'Nivel Medio', default, null, 'precalentar', 'Mantener buena postura'),
    (DEFAULT, "Prensas", "Ejercicio enfocado en la extensión de la cadera y la estabilización del torso, similar al levantamiento de una carga desde el suelo.", null, "Fuerza", default, 'Nivel Medio', default, null, 'precalentar', 'Mantener buena postura'),
    (DEFAULT, "Pesas", "Levantamiento que requiere la extensión de la cadera y la estabilización del torso, usando pesas.", null, "Fuerza", default, 'Avanzado', default, null, 'precalentar', 'Mantener buena postura'),
    (DEFAULT, "Bíceps", "Ejercicio que consiste en levantar una carga desde el suelo, trabajando principalmente los músculos de los brazos y la estabilidad del torso.", null, "Aeróbico", default, 'Avanzado', default, null, 'precalentar', 'Mantener buena postura');
