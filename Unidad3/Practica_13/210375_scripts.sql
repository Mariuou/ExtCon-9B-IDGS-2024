...
-- Elaborado por: T.S.U. Adalid Islas Quintero
-- Grado y Grupo: 9B
...
-- Tabla servicios al cliente
    ...
    CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_poblar_servicios_clientes`(v_password varchar(10))
        ...
        (default, 1, "Reclamo", '¿Cuáles son los dias en que se ofrecen clases de yoga?', 'Cliente interesado en conocer los dias de las clases de yoga.',default, default, default),
        ...
        (default, 4, default, "Excelentes instalaciones.", "Cliente muy satisfecho con el estado de las instalaciones",default, default, default),
        (default, 5, default, "Las máquinas estan en buenas condiciones", "Cliente expresa su agrado por las condiciones de los equipos del gimnasio",default, default, default);
    ...
    -- Tabla instalaciones
        ...
        CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_poblar_instalaciones`(v_password varchar(10))
            ...
            if v_password = '1234' then
                ...
                (Default, 'Yoga Room', 'Sala interior enfocada en las clases de yoga', "Área de Yoga", '2020-08-10 08:00:00', default, default, default,1,"Lunes a Viernes de 8:00am a 8:00pm", null, null),
                (Default, 'Fight Area', "Zona equipada con material de boxeo y ring para practicar artes marciales", "Área de entrenamiento de artes marciales",'2020-08-10 08:00:00', default, default, default,1,"Lunes a Viernes de 8:00am a 8:00pm", null, null),
